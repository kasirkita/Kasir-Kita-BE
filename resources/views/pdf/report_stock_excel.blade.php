...
<body>
    <table>
        <thead>
            <tr>
                <th colspan="5" style="text-align: center">Laporan Stok dari tanggal {{ Carbon\Carbon::parse($start_date)->format('d/m/Y') }} s/d {{ Carbon\Carbon::parse($end_date)->format('d/m/Y') }} </th>
            </tr>
        </thead>
        <thead>
            <tr>
